...
const SimpleProjectCard = ({
  ...
  <div className={`group relative w-full h-[400px] rounded-2xl overflow-hidden border border-neutral-200 transition-all duration-300 hover:shadow-xl hover:shadow-neutral-900/5 ${accentColor}`}>
      ...
      <div className="absolute bottom-0 left-0 p-8 w-full z-20 bg-linear-to-t from-white via-white/60 to-transparent pointer-events-none">
        <div className="flex justify-between items-end">
          <div>
            ...
            <h3 className="text-3xl font-bold text-neutral-900 relative z-10 drop-shadow-sm">{title}</h3>
          </div>
